  ...
  const getISTDateStr = () => {
    ...
    const dateInIST = new Date(istTime);
  ...
  export const AddTransactionModal: React.FC<AddTransactionModalProps> = ({
    ...
    useEffect(() => {
      if (isOpen) {
        if (existingTransaction) {
          ...
          setCategory('');
          // Always use IST date for new transactions
          setDate(getISTDateStr());
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      const payload: Transaction = {
        ...
        // Ensure the date is saved as ISO but based on the user's selected date (UTC Midnight)
